...
contract CompanyRegistry {
    ...
    event EcosystemUpdated(
        address indexed company1,
        address indexed company2,
        bool isPartnership
    );
    ...
    event IncludeeStatusUpdate(
        address indexed observer,
        address indexed includedCompany,
    ...
    function updateEcosystem(address _company2, bool _includesInEco) external {
        ...
        require(
            companies[_company2].walletAddress != address(0),
            "Company 2 not registered"
        );
        ...
        )
    {
        ...
        return (
            record.includesInEco,
            record.createdTimestamp,
            record.removedTimestamp
        );
    }
}
